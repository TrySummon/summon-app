    ...
    <div className="group/role">
      <Select onValueChange={onValueChange} value={value} disabled={disabled}>
        <SelectTrigger className={cn(
          "gap-1 w-fit shadow-none border-none bg-transparent dark:bg-transparent px-0 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-xs font-medium text-muted-foreground/70",
