...
export class ApiItemErrorBoundary extends Component<ApiItemErrorBoundaryProps, ApiItemErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      return (
        <div className="p-2 text-xs text-destructive flex items-center gap-2 justify-between">
