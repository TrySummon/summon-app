...
import DatasetItemDetailPage from "@/pages/DatasetItemDetailPage";
...
export const DatasetItemDetailRoute = createRoute({
  getParentRoute: () => RootRoute,
  path: "/datasets/$datasetId/item/$itemId",
  component: DatasetItemDetailPage,
});
